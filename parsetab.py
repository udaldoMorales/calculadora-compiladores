...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','a_sintac.py',6),
  ('expression -> expression SUBSTRACTION term','expression',3,'p_expression_SUBSTRACTION','a_sintac.py',10),
  ('expression -> term','expression',1,'p_expression_term','a_sintac.py',14),
  ('term -> term MULTIPLICATION factor','term',3,'p_term_MULTIPLICATION','a_sintac.py',18),
  ('term -> term DIVISON factor','term',3,'p_term_division','a_sintac.py',22),
  ('term -> factor','term',1,'p_term_factor','a_sintac.py',26),
  ('factor -> INTEGER','factor',1,'p_factor_int','a_sintac.py',30),
  ('factor -> DECIMAL','factor',1,'p_factor_dec','a_sintac.py',34),
  ('factor -> OPARENTHESIS expression CPARENTHESIS','factor',3,'p_factor_expr','a_sintac.py',38),
  ('factor -> OBRACKETS expression CBRACKETS','factor',3,'p_factor_brack_expr','a_sintac.py',42),
]
